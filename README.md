...
####lmdb [![GoDoc](https://godoc.org/github.com/thanhphu/lmdb-go/lmdb?status.svg)](https://godoc.org/github.com/thanhphu/lmdb-go/lmdb) [![stable](https://img.shields.io/badge/stability-stable-brightgreen.svg)](#user-content-versioning-and-stability)

```go
import "github.com/thanhphu/lmdb-go/lmdb"
```

Core bindings allowing low-level access to LMDB.

####lmdbscan [![GoDoc](https://godoc.org/github.com/thanhphu/lmdb-go/lmdbscan?status.svg)](https://godoc.org/github.com/thanhphu/lmdb-go/lmdbscan) [![stable](https://img.shields.io/badge/stability-stable-brightgreen.svg)](#user-content-versioning-and-stability)

```go
import "github.com/thanhphu/lmdb-go/lmdbscan"
```
...
####exp/lmdbpool [![GoDoc](https://godoc.org/github.com/thanhphu/lmdb-go/exp/lmdbpool?status.svg)](https://godoc.org/github.com/thanhphu/lmdb-go/exp/lmdbpool) [![experimental](https://img.shields.io/badge/stability-experimental-red.svg)](#user-content-versioning-and-stability)


```go
import "github.com/thanhphu/lmdb-go/exp/lmdbpool"
```
...
####exp/lmdbsync [![GoDoc](https://godoc.org/github.com/thanhphu/lmdb-go/exp/lmdbsync?status.svg)](https://godoc.org/github.com/thanhphu/lmdb-go/exp/lmdbsync) [![experimental](https://img.shields.io/badge/stability-experimental-red.svg)](#user-content-versioning-and-stability)


```go
import "github.com/thanhphu/lmdb-go/exp/lmdbsync"
```
...
[documentation](https://godoc.org/github.com/thanhphu/lmdb-go/lmdb) so they are
...
[documentation](https://godoc.org/github.com/thanhphu/lmdb-go/exp/lmdbsync) for
...
[issue](https://github.com/thanhphu/lmdb-go/issues/1).
...
of lmdb.  In addition to [godoc](https://godoc.org/github.com/thanhphu/lmdb-go)
...
- Its simpler design and implementation in pure Go mean it is free of many
  ...
  [documentation](https://godoc.org/github.com/thanhphu/lmdb-go/lmdb).
...
`go get github.com/thanhphu/lmdb-go/lmdb`
...
[godoc.org](https://godoc.org/github.com/thanhphu/lmdb-go) is the primary source
...
####[github.com/thanhphu/raft-mdb](https://github.com/thanhphu/raft-mdb) ([godoc](https://godoc.org/github.com/thanhphu/raft-mdb))
...
####[github.com/thanhphu/cayley/graph/lmdb](https://github.com/thanhphu/cayley/tree/master/graph/lmdb) ([godoc](https://godoc.org/github.com/thanhphu/cayley/graph/lmdb))
